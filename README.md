...
### 💡 Testing Flutter Code Result (Flutter MVVM - Pass)

![Testing Flutter Code Result](./doc/static/diagram.png)

### 💡 Testing Dart Code Result (Dart TictacToe Game - Fail)

![Testing Dart Code Result](./doc/static/diagram_fail.png)
...
![Testing Flutter Code Result](./doc/static/diagram_flutter.png)

### 💡 Testing BAD Dart Code Result
![Testing Dart Code Result](./doc/static/diagram_dart.png)
